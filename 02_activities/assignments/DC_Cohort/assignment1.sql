...
LIMIT 25;
-- I don't see any product ID 9s in the customer purchases. 
--END QUERY
...
--QUERY 9
SELECT customer.customer_id, customer.customer_first_name, customer.customer_last_name,SUM(customer_purchases.quantity * customer_purchases.cost_to_customer_per_qty) AS SUM_SPEND
FROM customer
...
Limit to 25 rows of output. */
--QUERY 11
--CREATE TABLE customer_dates AS 
