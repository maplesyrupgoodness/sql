...
A lot of our life exists in databases somewhere. I'm thinking about our photos, our finances, our passport numbers and social insurance numbers. In some ways, databases catalogue our our worth, standing, and existence in society, just like the article from Wired. I'm fine with having our life cataologued in such databases for simplicity sake for the most part, but one particular value system in databases I encounter from my day to day that irks me is my grades at school. My learning experiences, on whatever topic or subject, is distilled down to a particular letter grade or percentage, a pass or a fail, probably sitting somewhere in an SQL file on the University database. This system was setup beecause, in my opinion, that it can produce simple databases that can be quickly referenced. The system, though, never captures the nuances of learning. Parameters such as the time it took to learn something, wheather the knowledge would be retained beyond the particular class or test, the difficulty of that year, are lost. When students are forced to chase percentages, as even a few percentages on a test can determine a difference in letter grade, than the goal of learning becomes diluted. The goal of having a simple database system to determine a student's standing or excellence, cannot in my opinion, supercede what learning is meant to do. It should be the totality of what learning is to dictate what a database should be, not the other way around. The system has never been perfected, and I do not have the complete answer to how a perfect grading system should be, but we should take the opportunity to reflect on the system as whole, and if the system should be due for an upgrading. In some ways, the Unviversity system of grading have fallen prey to Goodhart's law, and if we are not aware that the entire academic experience is being optimized for a single metric of letter grades, in part because that was easy to be databased, then we stand to lose what University should be - a place for learning, not letter grade chasing. 
